...
class Instructions extends Component {
  ...
  create() {
    /*We need to use the dispatch method again, this time inside create. The type of the action object used in 
    dispatch should match the action type we just imported, and there shouldn't be a payload. */
    store.dispatch({
      type: ADD_RECIPE
    })
  }
